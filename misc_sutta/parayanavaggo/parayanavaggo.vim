...
silent only
cd /media/sf_KONDANNO/texfiles/sutta/parayanavaggo
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/bin/vimhelp.txt
badd +1 parayanavaggo_pali.txt
badd +1 parayanavaggo_eng.txt
badd +0 parayanavaggo_master_alternating.tex
argglobal
silent! argdel *
argadd parayanavaggo_pali.txt
set stal=2
edit parayanavaggo_eng.txt
...
exe 'vert 1resize ' . ((&columns * 138 + 138) / 276)
exe 'vert 2resize ' . ((&columns * 137 + 138) / 276)
tabedit parayanavaggo_master_alternating.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 91 - ((26 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
91
