...
silent only
cd /media/KONDANNO/texfiles/sutta/mahanidana
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 mahanidana_pali.txt
badd +1 ~/bin/vimhelp.txt
badd +0 mahanidana_eng.txt
argglobal
silent! argdel *
argadd mahanidana_pali.txt
edit mahanidana_eng.txt
