...
silent only
cd /media/data/texfiles/sutta/AN1
...
badd +1 AN1_eng.txt
badd +1 AN1_pali.txt
badd +58 ~/data/texfiles/Patimokkha2/PM_PaliNumbers.tex
badd +1 pali1_10.vim
badd +1 ~/.vimrc
badd +1 test.vim
badd +1 palinumregisters.txt
badd +1 ._r3jf.^
badd +1 AN1_master_alternating.tex
badd +675 AN1_pali_raw.txt
badd +0 AN1_pali_TOC.txt
argglobal
silent! argdel *
argadd AN1_eng.txt
set stal=2
...
exe 'vert 1resize ' . ((&columns * 89 + 90) / 180)
exe 'vert 2resize ' . ((&columns * 90 + 90) / 180)
tabedit AN1_master_alternating.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
nnoremap <buffer> <SNR>141_(v) v
nnoremap <buffer> <SNR>141_(V) V
xnoremap <buffer> <silent> <SNR>141_(vimtex-%) :call vimtex#motion#find_matching_pair(1)
xnoremap <buffer> <silent> <SNR>141_(vimtex-]]) :call vimtex#motion#next_section(0,0,1)
xnoremap <buffer> <silent> <SNR>141_(vimtex-][) :call vimtex#motion#next_section(1,0,1)
xnoremap <buffer> <silent> <SNR>141_(vimtex-[]) :call vimtex#motion#next_section(1,1,1)
xnoremap <buffer> <silent> <SNR>141_(vimtex-[[) :call vimtex#motion#next_section(0,1,1)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((15 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 253 - ((10 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
253
