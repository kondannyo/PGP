...
silent only
cd /media/sf_KONDANNO/texfiles/sutta/khagga
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/bin/vimhelp.txt
badd +1 khagga_eng.txt
badd +1 khagga_pali.txt
badd +0 khagga_master_alternating.tex
badd +206 ~/bin/txmkr
badd +46 ~/bin/txmakerwrapper.py
argglobal
silent! argdel *
argadd khagga_eng.txt
set stal=2
edit khagga_pali.txt
...
silent! normal! zE
let s:l = 61 - ((59 * winheight(0) + 33) / 66)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 66 - ((64 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
...
exe 'vert 1resize ' . ((&columns * 138 + 138) / 276)
exe 'vert 2resize ' . ((&columns * 137 + 138) / 276)
tabedit khagga_master_alternating.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 89 - ((24 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
89
