...
silent only
cd /media/sf_KONDANNO/texfiles/sutta/madhupindika
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 madhupindika_eng.txt
badd +1 ~/bin/vimhelp.txt
badd +0 madhupindika_pali.txt
argglobal
silent! argdel *
argadd madhupindika_eng.txt
set stal=2
edit madhupindika_pali.txt
...
silent! normal! zE
let s:l = 299 - ((13 * winheight(0) + 33) / 66)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 300 - ((14 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
300
