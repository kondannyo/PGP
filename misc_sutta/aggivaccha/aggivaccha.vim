...
silent only
cd /media/sf_KONDANNO/texfiles/sutta/aggivaccha
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/bin/vimhelp.txt
badd +1 aggivaccha_eng.txt
badd +1 aggivaccha_pali.txt
badd +5 repetition.txt
badd +0 aggivaccha_master_alternating.tex
argglobal
silent! argdel *
argadd aggivaccha_eng.txt
set stal=2
edit aggivaccha_pali.txt
...
exe 'vert 1resize ' . ((&columns * 138 + 138) / 276)
exe 'vert 2resize ' . ((&columns * 137 + 138) / 276)
tabedit aggivaccha_master_alternating.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 84 - ((19 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
