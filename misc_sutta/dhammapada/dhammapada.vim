...
silent only
cd /media/sf_KONDANNO/texfiles/sutta/dhammapada
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 dhammapada_pali.txt
badd +1 ~/bin/vimhelp.txt
badd +0 dhammapada_eng.txt
argglobal
silent! argdel *
argadd dhammapada_pali.txt
set stal=2
edit dhammapada_eng.txt
