...
silent only
cd /media/sf_KONDANNO/texfiles/sutta/mahatanhasankhaya
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/bin/vimhelp.txt
badd +616 mahatanhasankhaya_eng.txt
badd +636 mahatanhasankhaya_pali.txt
badd +1 .vimrc
badd +1 ~/.vimrc
badd +10 textblock.txt
badd +1 textsegmented.txt
badd +167 ../kayagata/kayagata_pali.txt
badd +150 ../kayagata/kayagata_eng.txt
argglobal
silent! argdel *
argadd mahatanhasankhaya_eng.txt
set stal=2
edit mahatanhasankhaya_eng.txt
...
let s:l = 636 - ((5 * winheight(0) + 33) / 66)
...
wincmd w
argglobal
edit mahatanhasankhaya_pali.txt
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 631 - ((0 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
631
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 123 - ((3 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
123
