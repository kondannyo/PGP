...
silent only
cd /media/data/texfiles/sutta/brahmajala
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/bin/vimhelp.txt
badd +1 brahmajala_pali.txt
badd +1 brahmajala_eng.txt
badd +1 ../potthapada/potthapada_pali.txt
badd +1 ../potthapada/potthapada_eng.txt
badd +1 ~/data/vimhelp.txt
badd +1 workflow.txt
argglobal
silent! argdel *
argadd brahmajala_pali.txt
set stal=2
edit brahmajala_eng.txt
...
silent! normal! zE
let s:l = 127 - ((8 * winheight(0) + 18) / 37)
...
21
normal! 0
tabedit ../potthapada/potthapada_eng.txt
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit ../potthapada/potthapada_pali.txt
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
