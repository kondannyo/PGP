...
silent only
cd /media/data/texfiles/sutta/sigalaka
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/bin/vimhelp.txt
badd +1 sigalaka_eng.txt
badd +1 sigalaka_pali.txt
argglobal
silent! argdel *
argadd sigalaka_eng.txt
set stal=2
edit sigalaka_pali.txt
...
silent! normal! zE
let s:l = 110 - ((16 * winheight(0) + 16) / 33)
