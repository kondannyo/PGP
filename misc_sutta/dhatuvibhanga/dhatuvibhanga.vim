...
silent only
cd /media/sf_KONDANNO/texfiles/sutta/dhatuvibhanga
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/bin/vimhelp.txt
badd +1 dhatuvibhanga_pali.txt
badd +327 dhatuvibhanga_eng.txt
badd +0 dhatuvibhanga_master_alternating.tex
argglobal
silent! argdel *
argadd dhatuvibhanga_pali.txt
set stal=2
edit dhatuvibhanga_eng.txt
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 327 - ((58 * winheight(0) + 33) / 66)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
327
...
exe 'vert 1resize ' . ((&columns * 138 + 138) / 276)
exe 'vert 2resize ' . ((&columns * 137 + 138) / 276)
tabedit dhatuvibhanga_master_alternating.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
