...
silent only
cd /media/data/texfiles/sutta/AN2
...
badd +1 AN2_eng.txt
badd +1 ~/.vimrc
badd +1 AN2_eng_raw.txt
badd +114 AN2_eng_seg.txt
badd +2 AN2_pali_raw.txt
badd +4 BodhiChanges.txt
badd +1 help
badd +1 check.txt
badd +24 checkpali.txt
badd +0 AN2_pali_TOC.txt
argglobal
silent! argdel *
argadd AN2_pali.txt
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 111 - ((29 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
111
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 163 - ((10 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
163
...
set winheight=1 winwidth=1
argglobal
edit /usr/share/vim/vim80/doc/motion.txt
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 1337 - ((32 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1337
