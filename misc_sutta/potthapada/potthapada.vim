...
set laststatus=2
set nomodeline
set operatorfunc=EasyClip#Yank#YankMotion
...
silent only
cd /media/KONDANNO/texfiles/sutta/potthapada
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/bin/vimhelp.txt
badd +1 potthapada_eng.txt
badd +14 potthapada_pali.txt
badd +1 ~/.Xresources
badd +231 ~/.vimrc
badd +672 ~/.vim/colors/solarized.vim
badd +95 potthapada_master_alternating.tex
badd +2 ../madhupindika/madhupindika_master_alternating.tex
badd +2 __Display_Results__
badd +3 scratchname
badd +38 @scratchname
argglobal
silent! argdel *
argadd potthapada_eng.txt
set stal=2
edit potthapada_eng.txt
...
exe 'vert 1resize ' . ((&columns * 89 + 90) / 180)
exe 'vert 2resize ' . ((&columns * 90 + 90) / 180)
tabedit potthapada_master_alternating.tex
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
nnoremap <buffer> <SNR>140_(v) v
nnoremap <buffer> <SNR>140_(V) V
xnoremap <buffer> <silent> <SNR>140_(vimtex-%) :call vimtex#motion#find_matching_pair(1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-]]) :call vimtex#motion#next_section(0,0,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-][) :call vimtex#motion#next_section(1,0,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-[]) :call vimtex#motion#next_section(1,1,1)
xnoremap <buffer> <silent> <SNR>140_(vimtex-[[) :call vimtex#motion#next_section(0,1,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-[[) :call vimtex#motion#next_section(0,1,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-[]) :call vimtex#motion#next_section(1,1,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-][) :call vimtex#motion#next_section(1,0,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-]]) :call vimtex#motion#next_section(0,0,1)
xnoremap <buffer> <silent> <SNR>125_(vimtex-%) :call vimtex#motion#find_matching_pair(1)
nnoremap <buffer> <SNR>125_(V) V
nnoremap <buffer> <SNR>125_(v) v
...
xnoremap <buffer> <silent> <SNR>127_(vimtex-[[) :call vimtex#motion#next_section(0,1,1)
xnoremap <buffer> <silent> <SNR>127_(vimtex-[]) :call vimtex#motion#next_section(1,1,1)
xnoremap <buffer> <silent> <SNR>127_(vimtex-][) :call vimtex#motion#next_section(1,0,1)
xnoremap <buffer> <silent> <SNR>127_(vimtex-]]) :call vimtex#motion#next_section(0,0,1)
...
xnoremap <buffer> <silent> <SNR>127_(vimtex-%) :call vimtex#motion#find_matching_pair(1)
nnoremap <buffer> <silent> <Plug>(vimtex-%) :call vimtex#motion#find_matching_pair()
nnoremap <buffer> <SNR>127_(V) V
nnoremap <buffer> <SNR>127_(v) v
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 221 - ((22 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
221
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 23 - ((10 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((17 * winheight(0) + 16) / 33)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
