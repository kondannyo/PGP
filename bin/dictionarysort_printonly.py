...
for row in dictarray:
    output_row = row.split(',')[0]
    print (output_row.encode('utf-8'))
with open(sorteddictionary_path, 'wb') as append_file:

    fieldnames = ['PALI', 'ENGLISH', 'CASE', 'NUM', 'GENDER', 'PERSON', 'VOICE', 'OBJECT', 'NOTES']
