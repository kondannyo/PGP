...
silent only
silent tabonly
cd /media/data/SC_split_files/mn
...
argglobal
%argdel
$argadd mn118_sc_pali
set stal=2
tabnew
tabrewind
edit /media/data/MN/sutta/MN_118_engl_anapanasati
...
silent! normal! zE
let s:l = 21 - ((7 * winheight(0) + 10) / 21)
...
wincmd w
argglobal
if bufexists("/media/data/Suttapitaka-Palitxt/MN3") | buffer /media/data/Suttapitaka-Palitxt/MN3 | else | edit /media/data/Suttapitaka-Palitxt/MN3 | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("mn118_sc_engl") | buffer mn118_sc_engl | else | edit mn118_sc_engl | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("mn118_sc_pali") | buffer mn118_sc_pali | else | edit mn118_sc_pali | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 167 - ((13 * winheight(0) + 21) / 42)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
...
tabnext 1
set stal=1
badd +64 mn118_sc_pali
badd +1 ~/bin/vimhelp.txt
badd +207 ~/.vimrc
badd +38 ~/testbin/testbed.vim
badd +55 mn118_sc_engl
badd +0 ~/vimrc
badd +2 /media/data/Suttapitaka-Palitxt/MN3
badd +2 /media/data/MN/sutta/MN_118_engl_anapanasati
