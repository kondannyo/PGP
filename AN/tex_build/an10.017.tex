...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{17. paṭhamanāthasutta}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{17. A Protector (1st)}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{yampi, bhikkhave, bhikkhu suvaco hoti … pe … anusāsaniṃ,}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{    -}}\\
\end{addmargin}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{yampi, bhikkhave, bhikkhu yāni tāni sabrahmacārīnaṃ … pe … alaṃ kātuṃ alaṃ saṃvidhātuṃ,}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{    -}}\\
\end{addmargin}
