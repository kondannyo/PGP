...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{32. appamādagāravasutta}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{32. Respect for Diligence}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{satthugāravatā, dhammagāravatā, saṅghagāravatā, sikkhāgāravatā, samādhigāravatā, appamādagāravatā, paṭisanthāragāravatā.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{Respect for the Teacher, for the teaching, for the Saṅgha, for the training, for immersion, for diligence, and for hospitality.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{saṃghe ca tibbagāravo;}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
