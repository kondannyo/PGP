...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{36. sāmaṇerasutta}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{36. A Novice}}\\
\end{addmargin}
\end{absolutelynopagebreak}

\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{“katihi nu kho, bhante, dhammehi samannāgatena bhikkhunā sāmaṇero upaṭṭhāpetabbo”ti?}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{“Sir, how many qualities should a mendicant have to be attended on by a novice?”}}\\
\end{addmargin}
\end{absolutelynopagebreak}

\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{“dasahi kho, upāli, dhammehi samannāgatena bhikkhunā sāmaṇero upaṭṭhāpetabbo.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{“Upāli, a mendicant should have ten qualities to be attended on by a novice.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{imehi kho, upāli, dasahi dhammehi samannāgatena bhikkhunā sāmaṇero upaṭṭhāpetabbo”ti.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{A mendicant should have these ten qualities to be attended on by a novice.”}}\\
\end{addmargin}
\end{absolutelynopagebreak}
