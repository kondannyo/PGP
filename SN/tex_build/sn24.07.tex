...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{‘natthi hetu, natthi paccayo … pe …}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{‘There is no cause or condition …}}\\
\end{addmargin}
\end{absolutelynopagebreak}

\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{sukhadukkhaṃ paṭisaṃvedentī’ti.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{they experience pleasure and pain in the six classes of rebirth.’}}\\
\end{addmargin}
\end{absolutelynopagebreak}
