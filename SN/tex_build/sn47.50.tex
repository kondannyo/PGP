...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{50. āsavasutta}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{50. Defilements}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{imesaṃ kho, bhikkhave, tiṇṇannaṃ āsavānaṃ pahānāya cattāro satipaṭṭhānā bhāvetabbā.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{The four kinds of mindfulness meditation should be developed to give up these three defilements.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{imesaṃ kho, bhikkhave, tiṇṇannaṃ āsavānaṃ pahānāya ime cattāro satipaṭṭhānā bhāvetabbā”ti.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{These four kinds of mindfulness meditation should be developed to give up these three defilements.”}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{amataṃ samudayo maggo,}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{    -}}\\
\end{addmargin}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{pātimokkhaṃ duccaritaṃ,}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{    -}}\\
\end{addmargin}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{mittavedanā āsavena cāti.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{    -}}\\
\end{addmargin}
