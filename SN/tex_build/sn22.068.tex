...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{68. anattasutta}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{68. Not-Self}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{“yo kho, bhikkhu, anattā; tatra te chando pahātabbo”ti.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{“Mendicant, give up desire for what is not-self.”}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{“rūpaṃ kho, bhante, anattā; tatra me chando pahātabbo.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{“Sir, form is not-self; I should give up desire for it.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{viññāṇaṃ anattā; tatra me chando pahātabbo.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{Consciousness is not-self; I should give up desire for it.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{rūpaṃ kho, bhikkhu, anattā; tatra te chando pahātabbo.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{Form is not-self; you should give up desire for it.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{viññāṇaṃ anattā; tatra te chando pahātabbo.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{Consciousness is not-self; you should give up desire for it.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
