...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{17. bhaginisutta}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{17. Sister}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{“na so, bhikkhave, satto sulabharūpo yo nabhaginibhūtapubbo … pe …}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{“It’s not easy to find a sentient being who in all this long time has not previously been your sister. …}}\\
\end{addmargin}
\end{absolutelynopagebreak}
