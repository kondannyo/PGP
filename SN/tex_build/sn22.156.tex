...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{156. attānudiṭṭhisutta}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{156. View of Self}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{“kismiṃ nu kho, bhikkhave, sati, kiṃ upādāya, kiṃ abhinivissa attānudiṭṭhi uppajjatī”ti?}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{“Mendicants, when what exists, because of grasping what and insisting on what, does view of self arise?”}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{“rūpe kho, bhikkhave, sati, rūpaṃ upādāya, rūpaṃ abhinivissa attānudiṭṭhi uppajjati.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{“When form exists, because of grasping form and insisting on form, view of self arises.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{viññāṇe sati, viññāṇaṃ upādāya, viññāṇaṃ abhinivissa attānudiṭṭhi uppajjati.}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{consciousness exists, because of grasping consciousness and insisting on consciousness, view of self arises.}}\\
\end{addmargin}
\end{absolutelynopagebreak}
...
\begin{absolutelynopagebreak}
\setstretch{.7}
{\PaliGlossA{api nu taṃ anupādāya attānudiṭṭhi uppajjeyyā”ti?}}\\
\begin{addmargin}[1em]{2em}
\setstretch{.5}
{\PaliGlossB{“But by not grasping what’s impermanent, suffering, and perishable, would view of self arise?”}}\\
\end{addmargin}
\end{absolutelynopagebreak}
